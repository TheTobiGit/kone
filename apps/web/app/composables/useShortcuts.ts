...
const ACTIONS: ShortcutAction[] = [
  ...
  {
    id: "zoom-in",
    label: "Scale the interface up",
    hint: "Everything on screen a step larger: text, spacing and chrome together.",
    group: "Always available",
    default: "mod+=",
    rebindable: false,
  },
  {
    id: "zoom-out",
    label: "Scale the interface down",
    hint: "Everything on screen a step smaller.",
    group: "Always available",
    default: "mod+-",
    rebindable: false,
  },
  {
    id: "zoom-reset",
    label: "Actual size",
    hint: "Put the interface back at 100%.",
    group: "Always available",
    default: "mod+0",
    rebindable: false,
  },
