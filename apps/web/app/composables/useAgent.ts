...
// Four components import the live registry projections from here
// (inbox/InboxThreadList.vue, inbox/AppInbox.vue,
// attention/AttentionGlobalBots.vue, studio/StudioRow.vue); they live in
// ./agent/agentLive, so they are re-exported to keep those imports.
export {
  liveTurns,
  liveAttention,
  setInlineThread,
