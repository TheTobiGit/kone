...
// the two brain hemispheres pulse in an opposing synaptic wave
const leftHemisphereVariants = {
  normal: { transform: "translate(0px, 0px) scale(1)" },
  animate: {
    transform: [
      "translate(0px, 0px) scale(1)",
      "translate(-0.8px, -0.4px) scale(1.05)",
      "translate(0.2px, 0.1px) scale(0.98)",
      "translate(0px, 0px) scale(1)",
    ],
...
const rightHemisphereVariants = {
  ...
  animate: {
    ...
    transition: { duration: 0.6, ease: [0.23, 1, 0.32, 1], delay: 0.06 },
  },
};
</script>
  ...
  >
    ...
    >
      <motion.path
        ...
        :variants="leftHemisphereVariants"
        :animate="controls"
        initial="normal"
      ...
      <motion.path
        ...
        stroke-linejoin="round"
        :stroke-width="strokeWidth"
        :variants="rightHemisphereVariants"
        :animate="controls"
        initial="normal"
