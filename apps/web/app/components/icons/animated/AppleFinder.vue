...
const iconVariants = {
  ...
  animate: {
    transform: ["rotate(0deg)", "rotate(-5deg)", "rotate(5deg)", "rotate(-2.5deg)", "rotate(0deg)"],
  ...
  >
    ...
    >
      <motion.g :variants="iconVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '12px 12px', transformBox: 'view-box' }">
        ...
        <path d="M7 8V10" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" :stroke-width="strokeWidth" />
        <path d="M17 8V10" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" :stroke-width="strokeWidth" />
        <path d="M7 16.5C10.5 18.5 13.5 18.5 17 16.5" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" :stroke-width="strokeWidth" />
