...
// the diamond perimeter pulses with a sharp shockwave while the exclamation point hops
const diamondVariants = {
  normal: { transform: "scale(1)" },
  animate: {
    transform: ["scale(1)", "scale(0.93)", "scale(1.05)", "scale(0.98)", "scale(1)"],
...
const stemVariants = {
  ...
  animate: {
    transform: ["scaleY(1)", "scaleY(1.22)", "scaleY(0.95)", "scaleY(1)"],
