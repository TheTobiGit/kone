...
// the stop square pulls taut under braking deceleration, compressing uniformly before snapping back
const stopVariants = {
  ...
  animate: {
    ...
    transition: { duration: 0.48, ease: [0.23, 1, 0.32, 1], times: [0, 0.28, 0.62, 0.82, 1] },
  },
};
</script>
