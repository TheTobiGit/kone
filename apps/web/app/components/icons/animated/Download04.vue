...
const iconVariants = {
  ...
  animate: {
    transform: ["translate(0px, 0px)", "translate(0px, 2.5px)", "translate(0px, 0px)"],
  ...
  >
    ...
    >
      <motion.g :variants="iconVariants" :animate="controls" initial="normal">
        ...
        <path d="M5.00006 21H19.0001" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" :stroke-width="strokeWidth" />
      </motion.g>
    </svg>
  </span>
</template>
