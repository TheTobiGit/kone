...
// the pencil pivots from its lead tip to sketch across the document
const pencilVariants = {
  normal: { rotate: 0, translateX: 0, translateY: 0 },
  animate: {
    rotate: [0, -8, 5, -2, 0],
    translateX: [0, -1, 1.2, -0.4, 0],
    translateY: [0, 0.4, -0.3, 0.1, 0],
...
const padVariants = {
  ...
  animate: {
    transform: ["translateY(0px)", "translateY(-0.5px)", "translateY(0.2px)", "translateY(0px)"],
