...
// the mute cross slides off toward the corner while a sound wave draws itself
// in, then a fresh cross flies back to replace it — a clean swap between muted
// and sounding without crossfading whole glyphs.
...
const MUTE_TIMES = [
  0, 0.05, 0.1, 0.16, 0.24, 0.34, 0.44, 0.56, 0.68, 0.76, 0.82, 0.87, 0.92,
  0.97, 1,
];

const departingMuteVariants = {
  normal: {
  ...
  animate: {
    ...
    transition: { duration: MUTE_DURATION, ease: "linear", times: MUTE_TIMES },
  },
};
