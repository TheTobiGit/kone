...
// the pencil scribbles actively from its tip while the sheet stays grounded
const pencilVariants = {
  normal: { transform: "rotate(0deg) translate(0px, 0px)" },
  animate: {
    transform: [
      "rotate(0deg) translate(0px, 0px)",
      "rotate(-8deg) translate(-1px, 1px)",
      "rotate(6deg) translate(1px, -1px)",
      "rotate(-3deg) translate(-0.5px, 0.5px)",
      "rotate(0deg) translate(0px, 0px)",
    ],
...
const sheetVariants = {
  ...
  animate: {
    transform: ["translateY(0px)", "translateY(-0.6px)", "translateY(0.2px)", "translateY(0px)"],
  ...
  >
    ...
    >
      ...
      <motion.path
        ...
        :animate="controls"
        initial="normal"
        :style="{ transformOrigin: '13.5px 21.5px' }"
      />
    </svg>
  </span>
</template>
