...
import { AiBrain01Icon, Copy01Icon, GitBranchIcon, Tick02Icon } from "@hugeicons/core-free-icons";
...
// whose bottom corners round off. Presentational — it reads the live session
// refs, so a running turn keeps the state and token rows current while it's open.
...
<template>
  <Teleport to="body">
    <div class="tip">
      ...
      <div class="tip__panel" role="dialog" aria-label="Thread info" :style="pos">
        ...
        <dl class="tip__rows">
          ...
          <template v-if="inGitProject">
            ...
            <div v-if="repo" class="tip__row">
              <dt>Repo</dt>
              <dd :title="repo">{{ repo }}</dd>
            </div>
            <div class="tip__row">
              <dt>Branch</dt>
