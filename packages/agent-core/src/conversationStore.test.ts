...
describe("v1 baseline migration and schema", () => {
  test("fresh DB opens at SCHEMA_VERSION = 8 with all baseline tables, columns, and indexes", () => {
    ...
    expect(migrations).toEqual([
      ...
      { migration_id: 6, name: "ConversationFts" },
      { migration_id: 7, name: "TurnCheckpoints" },
