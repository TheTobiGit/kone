// Human-scale number formatting for usage surfaces: spend in dollars, token
// counts with magnitude suffixes, and fractional shares as percentages. Pure
// Intl-based helpers with no I/O, so the desktop main process, the gateway,
// and the renderer all share the same rendering.
